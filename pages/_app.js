  ...
  return (
    <>
      ...
      >
        ...
        <Component {...pageProps} />
        <footer style={{ textAlign: "center", width: "100%", background: "#161616", minHeight: "20px", padding: "2px"}}>
          <Center><Text weight={500} size="sm">Made by Warun Panpaliya with </Text>&nbsp;<SiNextdotjs size="20px"/>&nbsp;<Text weight={500} size="sm">NextJs and </Text>&nbsp;<SiFastapi size="20px" />&nbsp;<Text weight={500} size="sm">FastApi.</Text></Center>
